...
class Api::V1::BaseController < ApplicationController
  ...
  rescue_from Exception, with: :notify500
  ...
  rescue_from TwitterApiClient::NotFoundAuthenticationError, Twitter::Error::Unauthorized, with: :rescue_not_found_authentication
